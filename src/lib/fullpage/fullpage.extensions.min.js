...
!(function (n, t) {
    ...
    Array.from ||
      (Array.from =
        ...
        function (n) {
          ...
          for (var l, u = i(o.length), c = t(e) ? Object(new e(u)) : new Array(u), s = 0; s < u; )
            (l = o[s]), (c[s] = a ? (void 0 === r ? a(l, s) : a.call(r, l, s)) : l), (s += 1)
          return (c.length = u), c
        }))
  var o = window,
    r = document,
  ...
  function D(n, t) {
    for ('string' == typeof t && (t = K(t)), n.appendChild(t); n.firstChild !== t; )
        ...
        (u = (function (n) {
          for (var t, e = '', i = 0, o = 0, r = 0; i < n.length; )
            (o = n.charCodeAt(i)) < 128
              ...
              : ((r = n.charCodeAt(i + 1)),
                (t = n.charCodeAt(i + 2)),
                (e += String.fromCharCode(((15 & o) << 12) | ((63 & r) << 6) | (63 & t))),
                (i += 3))
          return e
        })(u)),
        u
  ...
  function Bt(n) {
    var t,
      ...
      i = Mt()
    return (
      i.autoScrolling && !i.scrollBar ? ((t = -n), (e = p(Fn)[0])) : ((t = n), (e = window)),
      { options: t, element: e }
    )
  }
  function Gt(n, t) {
  ...
  function de(n, t, e) {
    ...
    Mt().anchors.length &&
      !Mt().lockAnchors &&
      (n
        ? (null != e && (i = e), null == t && (t = n), pn({ B: t }), ve(i + '/' + t))
        : null != n
        ? (pn({ B: t }), ve(e))
        : ve(e)),
      se()
  ...
  function ye() {
    ...
    g(this, vt)
      ...
      : Se().m.right && (pn({ H: 'slideArrow' }), dn.L(bn, { section: n }))
  }
  function Me(n) {
    !Mt().loopHorizontal &&
      Mt().controlArrows &&
      (J(p(pt, n.section), 0 !== n.slideIndex), J(p(ht, n.section), null != y(n.destiny)))
  }
  function Te() {
      ...
      !1 === re('onSlideLeave', a)
        ...
        : ((kt('dropEffect') && Mt().dropEffect) || (E(t, Yn), R(F(t), Yn)),
          ...
          Mt().interlockedSlides &&
            s.interlockedSlides &&
            ((kt('continuousHorizontal') && void 0 !== e && e !== a.xMovement) ||
  ...
  function Pe() {
    ...
    for (var i = '', o = 0; o < hn().N.length; o++) {
      ...
      void 0 !== u &&
        '' !== u &&
        (i += '<div class="fp-tooltip fp-' + Mt().navigationPosition + '">' + u + '</div>'),
        (i += '</li>')
    }
    ...
    ;(e = n),
      ...
      (function (n, t) {
        ...
        Mt().navigation &&
          ...
          (R(p(Un, e), Yn), E(n ? p('a[href="#' + n + '"]', e) : p('a', p('li', e)[t]), Yn))
      })(n, t)
  }
  ...
  function Ue(n, t, e) {
    ...
    if (null != i) {
      ...
      if (
        !(
          (hn().P.item == i && !vn.F) ||
          (Mt().scrollBar && W() === a.dtop && !g(i, 'fp-auto-height'))
        )
      ) {
        if (
          (null != a.activeSlide &&
            ((o = Z(a.activeSlide, 'data-anchor')), (r = T(a.activeSlide, null))),
          !a.localIsResizing)
        ) {
          var l = a.yMovement
          if (
  ...
  function Xe(n) {
    ...
    return (
      t > m() ? ((o || a) && 'bottom' !== a) || (i = r) : (o || (vn.F && null == y(n))) && (i = r),
      kt('offsetSections') && (i = s.offsetSections.getSectionPosition_(o, i, n)),
      pn({ K: i }),
      i
    )
  }
  ...
  function ni(n) {
    Mt().verticalCentered &&
      ((!Mt().scrollOverflow && li.gn(n.item)) || li.mn(n) || g(n.item, rt) || E(n.item, rt))
  }
  ;(s.moveTo = moveTo),
  ...
  var ai,
    li = {
      ...
      bn: function () {
        Mt().scrollOverflowMacStyle && !l && E($t, 'fp-scroll-mac'),
          hn().un.forEach(function (n) {
            if (
              !((n.slides && n.slides.length) || (g(n.item, 'fp-auto-height-responsive') && $e()))
            ) {
              var t,
                e = Vt(n.item),
                i = li.gn(n.item),
      ...
      Pn: function (n, t) {
        ...
        var e = li.Ln(t)
        if (!Mt().scrollOverflow || !g(e, at) || g(t, 'fp-noscroll') || g(Vt(t), 'fp-noscroll'))
          return !0
        var i = c ? 1 : 0,
          o = e.scrollTop,
          r = 'up' === n && o <= 0,
      ...
      Dn:
        ...
        function (n) {
          ...
          ;(ai = t),
            X(Mt().onScrollOverflow) && re('onScrollOverflow', { position: t, direction: e }),
            g(n.target, at) &&
              vn.canScroll &&
              li.Pn(e, n.target) &&
              li.Hn() &&
    ...
    ;(vn.P = null),
      ...
      (function () {
        ...
        if (!n && vn.N.length && !hn().C) {
          if (ui) {
            var i = vi(ui, vn.N)
            i && ((vn.P = i), (vn.P.isActive = !0), E(vn.P.item, Yn)),
          ...
          if (t && !e && ci) {
            ...
            o &&
              ...
              vn.P.activeSlide && Re(vn.P.activeSlide.item, 'internal')
          }
        }
      })(),
  ...
  function wi(n) {
          ...
          (function (n) {
            ...
            H(p(et, t)[0], e),
              ...
              '#fff' !== Mt().controlArrowColor &&
                ...
                b(p(pt, t), {
                  'border-color':
                    'transparent ' + Mt().controlArrowColor + ' transparent transparent',
                })),
    ...
    null != c && vn.P && (0 !== vn.P.index() || (0 === vn.P.index() && 0 !== c.index()))
  ...
  dn.R(yn, function () {
    ...
    Mt().observer &&
      ...
      p(Fn)[0] &&
      ((n = p(Fn)[0]), (t = bi), (e = new MutationObserver(yi)).observe(n, t), (hi = e)),
      dn.R(Tn, yi)
  }),
    (s.render = yi)
  var Mi = (function () {
  ...
  function Hi() {
    ...
    n || (!Mt().loopBottom && !Mt().continuousVertical) || (n = hn().N[0]),
      null != n
        ? Ue(n, null, !1)
        : yt().scrollHeight < $t.scrollHeight && Mt().scrollBar && Mt().Zn && dn.L(Ln)
  }
  function Ci() {
    var n = hn().P.prev()
  ...
  function Wi(n) {
    Mt().autoScrolling &&
      (vn.canScroll && (n.pageY < Ii && Se().m.up ? Ci() : n.pageY > Ii && Se().m.down && Hi()),
      (Ii = n.pageY))
  }
  function Fi(n) {
    if (Se().m[n]) {
      ...
      kt('scrollHorizontally') &&
        (t = Et('scrollHorizontally', 'getScrollSection', { type: n, scrollSection: t })),
      ...
      ? (function (n) {
          ...
          if (vn.canScroll) {
            if (
              ...
              e
                ? null == P(e, '.fp-section.active,.fp-section.active .fp-slide.active') &&
                  (e = o(n))
                : o(n)
              var a = e == i[0],
                l = e == i[i.length - 1],
              ...
              if (u || (!t && l)) {
                ...
                var c = (function (n) {
                    ...
                    do {
                      ;(i = wo(o.item)).length && (t = { Yn: o, Un: i[n ? i.length - 1 : 0] }),
                        (o = Zt(o[e]()))
                    } while (o && 0 === i.length)
                    return t
                  })(u),
                ...
                if (s) {
                  ...
                  dn.L(xn, { Xn: f.index() + 1, slideAnchor: s.rn ? 0 : s.index() }),
                    (Bi = c.Un),
                    V(n)
                }
              }
  ...
  function yo(n) {
    n
      ...
      : (r.addEventListener
          ? (Y('mousewheel', Mo, !1), Y('wheel', Mo, !1), Y('MozMousePixelScroll', Mo, !1))
    ...
    var t = new Date().getTime(),
      ...
      i = (function (n, t) {
        ...
        if (hn().C) {
          if (e) {
            var o
            if (!(i || (Pi('isNewKeyframe', 'beyondFullpage') && Ei.Wn())))
              return (
                (o = Bt(rn(hn().N).item.offsetTop + rn(hn().N).item.offsetHeight)).element.scrollTo(
                  0,
                  o.options
                ),
                pn({ Vn: !1 }),
      ...
      ? (yo(!0),
        (function () {
          if (Qi.Bn && (a || u) && (!kt('dragAndMove') || 'mouseonly' === Mt().dragAndMove)) {
            Mt().autoScrolling &&
              ($t.removeEventListener(Qi.Bn, eo, { passive: !1 }),
              $t.addEventListener(Qi.Bn, eo, { passive: !1 }))
            var n = Mt().touchWrapper
            n.removeEventListener(Qi.Gn, qi),
              n.removeEventListener(Qi.Bn, Ji, { passive: !1 }),
              n.addEventListener(Qi.Gn, qi),
              n.addEventListener(Qi.Bn, Ji, { passive: !1 })
          }
        })())
      : (yo(!1),
        (function () {
          if (Qi.Bn && (a || u)) {
            Mt().autoScrolling &&
              ($t.removeEventListener(Qi.Bn, Ji, { passive: !1 }),
              $t.removeEventListener(Qi.Bn, eo, { passive: !1 }))
            var n = Mt().touchWrapper
  ...
  function Zo() {
    if (!vn.V && !Mt().lockAnchors) {
      ...
      t &&
        t.length &&
        ((t && t !== vn.Z && !i) || (o && !Rt()) || (!vn.W && vn.B != e && !Rt())) &&
        dn.L(xn, { Xn: t, slideAnchor: e })
    }
  }
  function Bo(n) {
    var t = n.target
  ...
  function Qo(n) {
    ...
    if (
      ...
      !vn.F &&
        ...
        !hn().C &&
          !hn().Vn &&
          (!Mt().autoScrolling || Mt().scrollBar || kt('dragAndMove')) &&
          !Lt()))
    ) {
      var a = kt('dragAndMove') ? Math.abs(Et('dragAndMove', 'getCurrentScroll')) : W(),
        ...
        c = a + m() / 2,
        s =
          (kt('dragAndMove') ? Et('dragAndMove', 'getDocumentHeight') : $t.scrollHeight - m()) ===
          a,
        f = hn().N
      if ((pn({ scrollY: a }), s)) u = f.length - 1
      else if (a)
        for (var d = 0; d < f.length; ++d) (P(f[d].item, Qn) || f[d].item).offsetTop <= c && (u = d)
      else u = 0
      if (
        ((i = l),
        ...
        (r = o + m()),
        ('up' == i ? r >= W() + m() : o <= W()) &&
          (g(hn().P.item, Xn) || (E(hn().P.item, Xn), R(F(hn().P.item), Xn))),
        (e = (t = f[u]).item),
        !t.isActive)
      ) {
        pn({ V: !0 })
                ...
                t.split('-').forEach(function (n, t) {
                  if (t < 4) {
                    for (var e = 0, i = 0; i < 4; i++)
                      i !== u[t] && ((e += Math.abs(r(n[i]))), isNaN(n[i]) || c++)
                    var o = a(e)
                    s += o
                  }
                }),
  ...
  function ur(n) {
    if (
      ...
      (or = or.firstChild),
      'MutationObserver' in window &&
        new MutationObserver(sr).observe(r.body, { childList: !0, subtree: !1 }),
      (!lr || (kt(n) && s[n])) &&
        (!(function (n) {
          ...
          return (
            ...
            e.forEach(function (e) {
              var o = (function () {
                  if (r.domain.length) {
                    for (var n = r.domain.replace(/^(www\.)/, '').split('.'); n.length > 2; )
                      n.shift()
  ...
  function vr() {
    ...
    //   : (Mt() && vn.Kn) || r.domain.indexOf('alvarotrigo.com') > -1
    //   ? n && n.length
    //   : (f('error', 'Incorrect `licenseKey`. Get one for fullPage.js version 4 here:'),
    ...
    //           ;(e.length || t.length) &&
    //             f('error', '"' + n + '" is is being used by another element `' + i + '` property')
    //         }
    //       }))
  }
  function pr() {
    ...
    if ((($t = p('body')[0]), (ne = p('html')[0]), (te = p('html, body')), !g(ne, Gn)))
      return (
        ...
        (s.test = Object.assign(s.test, {
          ...
          dn: (function () {
            for (var n = [], t = 0; t < p(Mt().sectionSelector, yt()).length; t++)
  ...
  return (
    (s.destroy = function (n) {
      _(yt(), 'destroy', n),
        ...
        n &&
          (Jt(0),
          p('img[data-src], source[data-src], audio[data-src], iframe[data-src]', yt()).forEach(
            function (n) {
              ln(n, 'src')
            }
          ),
